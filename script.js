...
function setupContactForm() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (
      ...
      if (note) {
        note.textContent =
          "Email service not configured yet. Add your EmailJS keys in script.js.";
      }
      return;
    }
    ...
    window.emailjs
      .send(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, {
        ...
        reply_to: email,
        message,
        to_email: "shiven.thakur2005@gmail.com",
      })
      .then(
        () => {
          if (note) note.textContent = "Message sent! We’ll get back to you soon.";
          form.reset();
        },
        () => {
          if (note) {
            note.textContent =
              "There was a problem sending. Please try again or email shiven.thakur2005@gmail.com directly.";
          }
        }
      );
  });
